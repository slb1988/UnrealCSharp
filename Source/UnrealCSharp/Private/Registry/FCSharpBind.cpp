...
MonoObject* FCSharpBind::Bind(FDomain* InDomain, UObject* InObject, const bool bIsWeak)
{
	if(!bIsWeak)
	{
...
MonoObject* FCSharpBind::Bind(FDomain* InDomain, UClass* InClass, const bool bIsWeak)
{
	...
	return Bind(InDomain, static_cast<UObject*>(InClass), bIsWeak);
}

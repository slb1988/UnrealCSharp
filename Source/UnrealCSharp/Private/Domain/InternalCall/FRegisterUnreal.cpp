...
namespace
{
	...
	struct FRegisterUnreal
	{
		                                           ...
		                                           const bool bCopyTransientsFromClassDefaults)
		{
			...
			return FCSharpEnvironment::GetEnvironment().Bind(Object, true);
		}
		                                              ...
		                                              const FGarbageCollectionHandle InUserWidgetClass)
		{
			...
			return FCSharpEnvironment::GetEnvironment().Bind(UserWidget, true);
		}

		static MonoObject* GWorldImplementation()
		{
			return FCSharpEnvironment::GetEnvironment().Bind(GWorld, true);
		}
